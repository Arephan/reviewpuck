...
export class GitHubClient {
   ...
   */
  async getCommentContext(commentId: number, prNumber: number): Promise<CommentContext> {
   ...
   */
  async getBotComments(prNumber: number, botIdentifier: string): Promise<{ id: number; body: string }[]> {
 ...
 */
export function parseActionContext(): ActionContext {
